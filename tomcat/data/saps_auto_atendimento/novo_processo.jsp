...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <%
      ...
      if (!(logd.equals("true"))) {
        response.sendRedirect("login.jsp?type=danger&&message=Acesso Negado! VocÍ n„o est· conectado.");
      }
    %>
        ...
        <div class="container-fluid">
          <table>
            <tr>
              ...
              <td>
                <font color='#FFFFFF'>Calculadora de CobranÁa:</font>
                <br />
                <font color='#FFFFFF'>¡rea (m2): </font>
      ...
      <div id="sidebar">
        <div id="sidebar-shortcuts">
          <div id="sidebar-shortcuts-large">
            ...
            <a class="btn btn-small btn-success" title="Nova EdificaÁ„o" href="edificacao.jsp">
              <i class="icon-home"></i>
            </a>
        ...
        <ul class="nav nav-list">
          ...
          <li>
            ...
            <ul class="submenu">
              ...
              <!--li> <a href="/serten/projetos/areceber_distribuicao">A Receber Distribui√ß√£o</a></li>
          ...
          <!--li>
                  ...
                  <ul class="submenu">
                          <li><a href="/serten/analises">An√°lises</a></li>

                          <li><a href="/serten/vistorias">Vistorias</a></li>

                          <li><a href="/serten/vistorias/distribuicoes">Vistorias Distribu√≠das</a></li>
          ...
          <li>
                  ...
                  <ul class="submenu">
                          ...
                          <li><a href="/serten/fiscalizacoes/relatorio">Relat√≥rio</a></li>
          ...
          <!--li>
                  ...
                  <ul class="submenu">
                          <li><a href="/serten/gestao/arrecadacao">Arrecada√ß√£o</a></li
          ...
          <li>
                  ...
                  <ul class="submenu">
                          <li> <a href="/serten/usuarios">Usu√°rios</a></li>
                          <li> <a href="/serten/admin/acl">Permiss√µes</a></li>
        ...
        <div id="page-content" class="clearfix">
          <script type="text/javascript">
            $(document).ready(function () {
              ...
              /* Antes de submeter o formul·rio de notificaÁ„o toma o valor do editor e seta no valor da dsc_notificacao do formul·rio a ser submetido */
              $("#ProjetoAddForm").submit(function () {

                var engenheiro = $('#engenheiro').val();//valor engenheiro
                var tipoprojeto = $('#tipoprojeto').val()//tipo projeto

                if (tipoprojeto == '') {//verifica se È do tipo completo e n√£o foi selecionado um engenheiro
                  alert('Por favor selecione o tipo de projeto!');
                  return false;
                }

                if (engenheiro == '' && tipoprojeto == 1) {//verifica se È do tipo completo e n√£o foi selecionado um engenheiro
                  alert('Em projetos Completos È necess·rio indicar o Engenheiro Respos·vel!\nPor favor selecione um engenheiro!');
                  return false;
                }

                if (engenheiro == '' && tipoprojeto == 2) {//verifica se È do tipo tempor·rio e n√£o foi selecionado um engenheiro
                  alert('Em projetos Tempor·rios È necess·rio indicar o Engenheiro Respos·vel!\nPor favor selecione um engenheiro!');
                  $('#engenheiro').focus();
                  return false;
                }

                if (engenheiro == '' && tipoprojeto == 3) {//verifica se È do tipo subloja e n√£o foi selecionado um engenheiro
                  alert('Em projetos "Subloja" È necess·rio indicar o Engenheiro Respos·vel!\nPor favor selecione um engenheiro!');
                  $('#engenheiro').focus();
                  return false;
                }
                ...
                if (tipoprojeto == 2)
                {
                  ...
                  if (dias_total < 10)
                  {
                    if (confirm('Este evento n√£o cumpre com o prazo m√≠nimo de 10 dias CORRIDOS. Restam somente ' + dias_total + ' dias CORRIDOS para o evento. Tem certeza que deseja prosseguir?'))
                    {
              ...
              $(".nota input").change(function () {
                if ($(this).attr('checked')) {
                  ...
                  editor.updateFrame();// atualizando o valor do editor ap√≥s inserÁ„o dos valores na textarea
                }
              });
            });
          </script>
          ...
          <div class="toolbar">
            <div class="btn-group">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="/serten/edificacoes">Listar EdificaÁıes</a> </li>
                <li><a href="/serten/edificacoes/add">Nova EdificaÁ„o</a> </li>
              </ul>
            </div>
          </div><!--/.toolbar-->
            ...
            <div class="widget-body">
              <div class="widget-main">
                <div class="projetos form">
                  <form action="projeto" id="ProjetoAddForm" method="post" accept-charset="utf-8">
                    ...
                    <fieldset>
                      ...
                      <div class="input select required">
                        ...
                        <select name="Projeto.cod_tipoprojeto" id="tipoprojeto">
                      ...
                      <div class="input date">
                        ...
                        <select name="Projeto.dat_abertura.dia" id="dat_aberturaDay" class="span2">
                        ...
                        <select name="Projeto.dat_abertura.mes" id="dat_aberturaMonth" class="span2">
                          <option value="01">Janeiro</option>
                          <option value="02">Fevereiro</option>
                          <option value="03">MarÁo</option>
                        ...
                        <select name="Projeto.dat_abertura.ano" id="dat_aberturaYear" class="span2">
                      ...
                      <div class="input date">
                        ...
                        <select name="Projeto.dat_final.dia" id="dat_finalDay" class="span2">
                          <option value="01">1</option>
                          <option value="02">2</option>
                          <option value="03">3</option>
                          <option value="04">4</option>
                        ...
                        <select name="Projeto.dat_final.mes" id="dat_finalMonth" class="span2">
                          <option value="01">Janeiro</option>
                          <option value="02">Fevereiro</option>
                        ...
                        <select name="Projeto.dat_final.ano" id="dat_finalYear" class="span2">
                          <option value="2037">2037</option>
                          <option value="2036">2036</option>
                          <option value="2035">2035</option>
                          <option value="2034">2034</option>
                      ...
                      <div class="input select">
                        ...
                        <select name="Projeto.cod_geracao" id="geracao">
                          <option value="1">An·lise Comum</option>
                          <option value="2">An·lise AmpliaÁ„o</option>
                          <option value="3">Re-An·lise</option>
                          <option value="4">AutenticaÁ„o(Gerar no processo!)</option>
                      ...
                      <div class="input select">
                        <label for="engenheiro">Resp. TÈcnico</label>
                        <select name="Projeto.cod_eng" id="engenheiro" class="span4 live">
                          <option value="">-- Selecione o Respons·vel --</option>
                          <option value="1">ADRIAN MEDIEROS DA SILVA</option>
                      ...
                      <div class="input select required">
                        ...
                        <select name="Projeto.dsc_origem_obm" id="ProjetoDscOrigemObm">
                          <option value="">-- Selecione --</option>
                      ...
                      <div class="input text required">
                        <label for="ProjetoCodEdificacao">N∫ EdificaÁ„o SAPS</label>
                        <input name="Projeto.cod_edificacao" type="text" data-toggle="modal" data-target="#modal-busca" maxlength="30" id="ProjetoCodEdificacao" />
                      </div>
                        ...
                        <div class="widget-body">
                          <div class="widget-main">
                            <div class="box">
                              ...
                              <!--form-->
                              <a data-toggle="collapse" data-target="#g1" OnMouseOver="this.style.cursor = 'pointer';"><i class="icon-edit"></i> DOCUMENTOS ENTREGUES PELO PROPRIET√ÅRIO</a>
                              <div id="g1" class="collapse" >
                                <div class="box">
                                  ...
                                  <div class="nota">
                                    ...
                                    <label for="Tipo8">PROJETO ARQUITET√îNICO: 00 (QTDADE)<label>
                                  </div>
                                  <div class="nota">
                                  ...
                                  <div class="nota">
                                    <input type="checkbox" value="MÕDIA DIGITAL: ___" />
                                    <label for="Tipo8">MÕDIA DIGITAL: 00 (QTDADE)<label>
                                  </div>
                                  <div class="nota">
                      ...
                      <div class="input textarea">
                        ...
                        <textarea name="EntradaProjeto.dsc_docs" id="alvo" cols="30" rows="6" ></textarea>
                      </div>
                    </fieldset>
